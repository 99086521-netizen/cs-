...
darkModeBtn.style.postion = 'fixed';
...
const showModal = (text) => {
    ...
    modal.style.backgroundColor = 'rga(0, 0, 0, 0.8)';
...
footer.innerHTML = `© ${new Date().getFullYear()} All rights reserved by Luna Vazquez`;
